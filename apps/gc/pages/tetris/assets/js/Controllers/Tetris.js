Package('Gc.Controllers', {
	Tetris : new Class({
		...
		{
			this.game = new Gc.Engines.Tetris();
			this.game.listen('update', this.onUpdate.bind(this));
			this.view = new Gc.Views.Tetris(CONFIGURATION, selector);
...
SAPPHIRE.application.registerController('tetris', new Gc.Controllers.Tetris());
